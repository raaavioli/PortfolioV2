...
const YoutubeEmbed = ({ embedId }) => (
 	<div className="video-responsive">
		<div class="video-cover">
			<p>
			Water Rendering aimed to create a scene for rendering realistically looking water in real time based on Jerry Tessendorf's paper Simulating Ocean Water (2001).
			</p>
			<p>
			C++, OpenGL, CUDA, Fourier transforms
			</p>
		</div>
		<iframe
...
const IndexPage = () => {
  return (
    <main>
		...
		<div class="content-panel dark flex-column">
			<div class="head-panel dark flex-row">
				<div class="flex-column dark">
					<h1>Hi, I'm Oliver!</h1>
					<p class="dark">Computer scientist, rendering enthusiast and incurable adventure seeker.</p>
				</div>
				<img class="head-image" src={Portrait} alt="Me" />
			</div>
		</div>
		...
		<div class="content-panel flex-column">
			...
			<div class="projects-container flex-row">
				{projects.map(project => (
					<div class="project-box flex-column">
						<h3>{project.text}</h3>
		...
		<div class="content-panel flex-column">
			<div class="flex-row">
				<div class="qualification-box flex-column">	
					<h2>Experience</h2>
					<ul>
		...
		<div class="side-panel flex-column">
			<h3>Contact</h3>
			<a href="https://www.linkedin.com/in/olivereriksson96/">
				<svg class="svg-logo" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
